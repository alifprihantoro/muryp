...
> Yang paling penting tag html:5 sama seo-nya. Partial lainnya tergantung kalian.
...
<!--- title tags --->
{{- if .IsHome -}}
<title itemprop="name">{{ .Site.Title }} | Personal Blog</title>
{{- else -}}
...
<!-- Theme Color -->
<meta name="theme-color" content="{{ .Site.Params.nav1 }}" /> 
<meta name="msapplication-TileColor" content="{{ .Site.Params.nav1 }}" />

<meta name="keywords" content="{{ .Site.Params.Description }},{{ .Params.keywords }}" />
  ...
  <script defer type="application/ld+json">
    {
      ...
      "image": {
        "@type": "imageObject",
        "url": "{{ with .Params.image }}{{ . }}{{else}} {{ .Site.Params.og_image }}{{ end }}"
      },
      "publisher": {
        "@type": "Organization",
        "name": "{{ .Site.Title }}",
